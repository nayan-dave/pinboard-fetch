...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getItems: function getItems() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get('/api/items', {
        params: this.select_tags
    ...
    selectedTags: function selectedTags(event) {
      ...
      if (event.target.checked) {
        ...
        var _iterator = _createForOfIteratorHelper(this.select_tags),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var data = _step.value;
            if (data === tag) {
              var index = this.select_tags.indexOf(data);
...
var app = new vue__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  render: function render(h) {
    return h(_components_MainComponent__WEBPACK_IMPORTED_MODULE_0__["default"]);
  }
});
...
var render = function () {
  ...
  return _c("div", { staticClass: "container mt-4" }, [
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-md-3 m-auto mt-4" }, [
        _c(
          "div",
          ...
          [
            ...
            _vm._l(_vm.tags, function (tag) {
              return _c(
                "div",
                { key: tag.tag, staticClass: "list-group-item" },
                [
                  _c("label", [
                    _c("input", {
                      staticClass: "form-check-input",
                      attrs: { type: "checkbox", id: tag.tag },
                      domProps: { checked: tag.checked },
                      on: {
                        click: function ($event) {
                          return _vm.selectedTags($event)
                        },
                      },
                    }),
                    _vm._v(
      ...
      _c("div", { staticClass: "col-md-9" }, [
        _c(
          ...
          _vm._l(_vm.items, function (item) {
            return _c("div", { staticClass: "col-sm-4 col-md-4 col-lg-4" }, [
                ...
                _c("div", { staticClass: "card-body" }, [
                  _c(
                    "p",
                    {
                      ...
                      class: {
                        "text-success": item.live,
                        "text-danger": !item.live,
                      },
                    },
                    [_vm._v(_vm._s(item.live ? "Live" : "Not Live"))]
                  ),
                  _vm._v(" "),
